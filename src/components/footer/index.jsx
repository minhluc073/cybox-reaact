...
export const contactConfig = {
    YOUR_EMAIL: "themesflatc11@gmail.com",
    YOUR_FONE: "(84)922032190",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vehicula eu nunc et sollicitudin. Cras pulvinar, nisi at imperdiet pharetra. ",
    YOUR_SERVICE_ID: "service_nk03b9n",
    YOUR_TEMPLATE_ID: "template_9ckf6gs",
    YOUR_USER_ID: "eJfnZ4K8GglkEa7JB",
  };
            ...
            <div className="footer-main">
                ...
                <div className="container">
                    ...
                    <form action="#" id="subscribe-form" onSubmit={handleSubmit}>
                        <input type="email" name='email' value={formData.email} onChange={handleChange} placeholder="Enter your email address" required="" id="subscribe-email" />
